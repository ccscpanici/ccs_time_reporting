...
urlpatterns = [
    ...
    path("upload/<int:upload_pk>/job-corrections/", views.timesheet_upload_job_corrections, name="timesheet_upload_job_corrections"),
    ...
    path("active-projects/<int:pk>/remove/", views.active_project_remove, name="active_project_remove"),
    path("active-projects/<int:pk>/details/", views.active_project_detail, name="active_project_detail"),
    path("jobs/", views.job_list, name="job_list"),
    path("jobs/create/", views.job_create, name="job_create"),
    path("jobs/import/", views.job_import, name="job_import"),
    path("jobs/import/<int:pk>/", views.job_import_preview, name="job_import_preview"),
    path("jobs/import/<int:pk>/apply/", views.job_import_apply, name="job_import_apply"),
    path("jobs/invalid-cleanup/", views.invalid_job_cleanup, name="invalid_job_cleanup"),
    path("jobs/invalid-cleanup/<int:pk>/apply/", views.invalid_job_cleanup_apply, name="invalid_job_cleanup_apply"),
    ...
    path("<int:pk>/submitted/", views.timesheet_submitted, name="timesheet_submitted"),
    path("<int:pk>/package/", views.timesheet_package_download, name="timesheet_package_download"),
    ...
    path("<int:pk>/receipts/pdf/", views.timesheet_receipts_pdf, name="timesheet_receipts_pdf"),
    ...
    path("reopen-requests/", views.reopen_request_list, name="reopen_request_list"),
    path("reopen-requests/<int:pk>/", views.reopen_request_review, name="reopen_request_review"),
    path("reopen-requests/<int:pk>/approve/", views.reopen_request_approve, name="reopen_request_approve"),
